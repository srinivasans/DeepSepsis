...
def run_rlr():
    lr_model = LogisticRegression(C=0.00001, solver='lbfgs', max_iter=500, class_weight='balanced')
...
def run_xgb():
    xgb_model = XGBClassifier(n_estimators=40, max_depth=5, learning_rate=1, reg_lambda=1000, scale_pos_weight=55.6, n_jobs=-1)
